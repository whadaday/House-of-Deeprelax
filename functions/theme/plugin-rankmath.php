...
add_action( 'add_meta_boxes', function() {
    ...
    // Rankmath
    $key = 'rank_math_metabox';
    if(isset($wp_meta_boxes['page']['normal']['low'][$key])):
        $wp_meta_boxes['page']['normal']['low'][$key]['title'] = 'SEO';
    endif;

    if(isset($wp_meta_boxes['landingpage']['normal']['low'][$key])):
        $wp_meta_boxes['landingpage']['normal']['low'][$key]['title'] = 'SEO';
    endif;
