<?php
  ...
  // include( locate_template( 'partials/blog/blog-content-lead.php', false, false ) );
  // include( locate_template( 'partials/general/page-content.php', false, false ) );
  // include( locate_template( 'partials/blog/blog-related.php', false, false ) );
...
<?php
  ...
  if (have_posts()):
    ...
    while(have_posts()):
          ...
          <div class="container"> 
            ...
            <div class="columns columns-article">
              <div class="column column-article"> 
                  ...
                  include( locate_template( 'partials/blog/article-toc.php', false, false ) );
        ...
        <?php include_once( locate_template( 'partials/blog/blog-related.php', false, false ) ); ?>
